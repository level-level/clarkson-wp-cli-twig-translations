...
if(defined('WP_CLI') && WP_CLI) {
    class Gettext extends \WP_CLI_Command {
        ...
        public function prepareFiles(){
            $twig_args = array(
                'debug' => true,
                'cache' => apply_filters( 'clarkson_twig_translations_cache_path', realpath( get_stylesheet_directory() ) . '/dist/rendered-templates/' ),
                'auto_reload' => true
            );

            $basedir = apply_filters( 'clarkson_twig_translations_templates_path', realpath( get_stylesheet_directory() . '/templates/' ) );
